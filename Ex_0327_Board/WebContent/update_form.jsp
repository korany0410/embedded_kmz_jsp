...
<script>
	function send(f) {
		...
		f.search_text.value = encodeURIComponent(f.search_text.value);
		//제목,이름,내용,비밀번호에 대한 유효성 체크 했다고 치고
		console.log(f.page.value);
		console.log(f.search.value);
		console.log(f.search_text.value);
		f.action = "modify.do";
		f.method = "get";
		f.submit();
	...
	<form name="f">
		<table border="1" align="center" style="width: 600px;">
			...
			<tr>
				<th>작성자</th>
				<td>
					<input name="name" style="width: 500px;" value="${vo.name}">
				</td>
			</tr>
			<tr>
				<th>제목</th>
			...
			<tr>
				<th>내용</th>
				<td>
					<textarea name="content" rows="9" cols="74" style="resize: none;">${vo.content}</textarea>
				</td>
			</tr>
			<tr>
